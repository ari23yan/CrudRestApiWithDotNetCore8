...
const Person = ({ person ,onShowDeleteModal,onDelete,onShowUpdateModal,onUpdate}) => {
  ...
  {
    setDeleteModal(!showUpdateModal);
  }
    ...
    <tr>
      ...
      <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm text-right">
        <div className="m-3 text-center">
          <button onClick={()=> toggleDeleteModal()} className="mr-2 bg-white text-gray-800 font-bold rounded border-b-2 border-red-500 hover:border-red-600 hover:bg-red-500 hover:text-white shadow-md py-2 px-6 inline-flex items-center">
      ...
      {showDeleteModal && <DeletePerson perosnId={person.id} onSubmit={onDelete} onClose={toggleDeleteModal} />}
    </tr>
  )
};
